...
// =========== IO STDIN READ =============
int interface_send_io_stdin_read(int fd, uint32_t pid, char *physical_address, uint32_t offset, uint32_t size);
...
// =========== IO STDOUT WRITE  =============
int interface_send_io_stdout_write(int fd, uint32_t pid, char *physical_address, uint32_t offset, uint32_t size);
